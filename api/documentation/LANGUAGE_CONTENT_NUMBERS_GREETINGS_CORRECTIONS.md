...
| Good morning | `Mañana si Yu'os` as the old core beginner card | `Buenas dias` | Local dictionaries support `buenas dias`; the Kumisión cultural dictionary and Visit Guam attest `Manana si Yu'os` as Good morning. Keep `Manana si Yu'os` as a supported Guam usage variant, not as a deprecated/wrong form. |
