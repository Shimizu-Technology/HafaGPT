...
describe('lesson concept evidence', () => {
  ...
  it('replaces syntactically invalid saved progress without crashing the lesson quiz', async () => {
    const warning = vi.spyOn(console, 'warn').mockImplementation(() => undefined);
    window.localStorage.setItem(`hafagpt_quiz_${mocks.userId}_greetings`, '{invalid');
    ...
    expect(warning).toHaveBeenCalledWith('Failed to load quiz state:', expect.any(SyntaxError));
  });
